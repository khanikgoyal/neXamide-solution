...
<a href="https://www.facebook.com/people/Nexamind-soultion/61587297927673/" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-blue-500 transition cursor-pointer">
<FaFacebookF size={16} />
</a>
<a href="https://www.instagram.com/nexamindsolution/" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-blue-500 transition cursor-pointer">
<FaInstagram size={16} />
</a>
<a href="https://www.linkedin.com/company/nexamindsolution/" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-blue-500 transition cursor-pointer">
